...
<p>Ми не зберігаємо дані платіжних карт (PAN/CVV) на сервері. Платежі обробляються через WayForPay. Для перевірки квитка використовується підпис HMAC, який стає недійсним після повернення коштів.</p>
